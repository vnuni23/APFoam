...
#include "SaprcFallOffFunction.H"
#include "SaprcArrheniusReactionRate.H"
...
#define makeReactions(Thermo, Reaction)                                        \
    ...
    makeSaprc2kPressureDependentReactions                                        \
    (                                                                          \
       Thermo,                                                                 \
       SaprcArrheniusReactionRate                                                   \
    )                                                                          \
    makeSaprc3kPressureDependentReactions                                        \
    (                                                                          \
       Thermo,                                                                 \
       SaprcArrheniusReactionRate                                                   \
    )                                                                          \
